...
public class Version extends TitledObject implements Serializable  {
	@Column(name="state")	private String state;	@Column(name="released")	private java.util.Date released;	@OneToOne(cascade=CascadeType.ALL)
	                     	                     	                        	                                	@JoinColumn(name="project", referencedColumnName="ID")	public Project project;
